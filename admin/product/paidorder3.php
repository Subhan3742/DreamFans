...
<div class="container">
    ...
    <div class="col-3 bg-primary m-2 p-3 shadow">
        <a href="paidorder.php" class="text-decoration-none text-center text-white"> <h2>Order</h2></a>
        </div>
        <div class="col-3 bg-warning m-2 p-3 shadow">
        <a href="paidorder2.php" class="text-decoration-none text-center text-white"> <h2>Pending Order</h2></a>
        </div>
        <div class="col-3 bg-danger m-2 p-3 shadow">
        <a href="paidorder3.php" class="text-decoration-none text-center text-white"> <h2>Delivered Order</h2></a>
        </div>
    </div>
</div>
...
<div class="main">
    <div class="table-responsive">
        <table class="table table-hover mt-4 ">
            ...
            <?php
            include 'config.php';
            $record = mysqli_query($con, "SELECT * FROM `paid-order`");
            while ($row = mysqli_fetch_array($record)) {
                $check_page = $row['accept'];
                if ($check_page === 'deliver') {
                echo "
                <tr class='border'>
                ...
                <td>
                        ...
                        <a href='paid_order_delete_.php?ID={$row['order-no']}' class='btn btn-danger '>Delete</a>
                    </td>    
                </tr>
                ";
                }
